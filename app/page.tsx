...
import { products } from '@/lib/data/products'
import { companyInfo, workingAreas, services } from '@/lib/data/services'
import { ArrowRight, Globe, TrendingUp, Users, Award, ChevronLeft, ChevronRight, Sparkles, Clock, MapPin, CheckCircle2, Factory, Truck } from 'lucide-react'
...
const heroSlides = [
  ...
  {
    id: 2,
    image: '/images/n/IMG-20260418-WA0003.jpg',
    alt: 'Clemaster manufacturing facility',
  },
  {
    id: 3,
    image: '/images/n/in-factory-1.jpg',
    alt: 'Professional cleaning team',
  }
]

// Factory images data
const inFactoryImages = [
  {
    id: 1,
    image: '/images/n/in-factory-1.jpg',
    alt: 'Manufacturing facility interior',
    caption: 'Available Products in Stock'
  },
  {
    id: 2,
    image: '/images/n/in-factory-2.jpg',
    alt: 'Quality control process',
    caption: 'Alot of Production Materials'
  },
  {
    id: 3,
    image: '/images/n/in-factory-3.jpg',
    alt: 'Automated packaging system',
    caption: 'Inside warehouse'
  },
]

const outFactoryImages = [
  {
    id: 1,
    image: '/images/image_750x_67dacc4f4c879.jpg',
    alt: 'Delivery fleet',
    caption: 'Reliable distribution network'
  },
  {
    id: 2,
    image: '/images/hero-cleaning.jpg',
    alt: 'Client facility',
    caption: 'On-site client support'
  },
  {
    id: 3,
    image: '/images/image_750x_67dacc6f3da9f.jpg',
    alt: 'Product in use',
    caption: 'Products at work'
  }
]
...
export default function Home() {
  ...
  const areasRef = useRef<HTMLElement | null>(null)
  const servicesRef = useRef<HTMLElement | null>(null)
  const inFactoryRef = useRef<HTMLElement | null>(null)
  const outFactoryRef = useRef<HTMLElement | null>(null)
  ...
  const areasVisible = useIntersectionObserver(areasRef)
  const servicesVisible = useIntersectionObserver(servicesRef)
  const inFactoryVisible = useIntersectionObserver(inFactoryRef)
  const outFactoryVisible = useIntersectionObserver(outFactoryRef)
  ...
  return (
    <>
      ...
      <section className="relative h-[80vh] md:h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="max-w-3xl">
            {/* Animated Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-4 animate-fade-in-up">
              <Sparkles className="w-3.5 h-3.5 text-yellow-400" />
              <span className="text-xs sm:text-sm text-white/90 tracking-wide">Industry Leader Since 2021</span>
            </div>

            <div className="space-y-4 animate-fade-in-up animation-delay-200">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white text-balance leading-[1.2] tracking-tight">
                Professional Cleaning
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary-foreground to-white/80">
                  Solutions
                </span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-3">
                <Link href="/products">
                  <Button className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white w-full sm:w-auto h-11 text-sm sm:text-base shadow-lg shadow-primary/25 hover:shadow-xl transition-all duration-300 group">
                    Browse Products
                    <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
                  </Button>
                </Link>
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="border-white/30 text-white bg-white/10 backdrop-blur-sm hover:bg-white/20 hover:border-white/50 w-full sm:w-auto h-11 text-sm sm:text-base transition-all duration-300"
                  >
                    Get in Touch
                  </Button>
                </Link>
      ...
      <section ref={statsRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-background to-primary/5">
        <div className="container mx-auto max-w-7xl">
          <div className={`text-center mb-12 transition-all duration-700 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
              <TrendingUp className="w-4 h-4 text-primary" />
              <span className="text-sm text-primary font-medium">Why Choose Us</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">Industry-Leading Excellence</h2>
      ...
      <section ref={hoursRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="container mx-auto max-w-7xl">
          <div className={`text-center mb-12 transition-all duration-700 ${hoursVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
              <Clock className="w-4 h-4 text-primary" />
              <span className="text-sm text-primary font-medium">Business Hours</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">We're Here When You Need Us</h2>
            <p className="text-base text-muted-foreground max-w-2xl mx-auto">
              Get in touch with our team during these hours for prompt assistance.
            </p>
          </div>
...
{/* <section ref={outFactoryRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-background">
  <div className="container mx-auto max-w-7xl">
    <div className={`transition-all duration-700 ${outFactoryVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
        <div className="text-center sm:text-left">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">Out in the Field</h2>
          <p className="text-base text-muted-foreground max-w-2xl">
            See our products and services in action across various client locations and applications.
          </p>
        </div>
        <Link 
          href="/gallery?filter=field" 
          className="group inline-flex items-center gap-2 px-4 py-2 mt-4 sm:mt-0 rounded-full bg-primary/10 hover:bg-primary/20 border border-primary/20 text-primary transition-all duration-300"
        >
          <span className="text-sm font-medium">View Gallery</span>
          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
    ...
    <div className="grid md:grid-cols-3 gap-6">
      {outFactoryImages.map((image, index) => (
        <div
          key={image.id}
          className={`group relative overflow-hidden rounded-2xl bg-card border border-border transition-all duration-500 hover:shadow-xl hover:-translate-y-1 ${outFactoryVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          style={{ transitionDelay: `${index * 100}ms` }}
        >
          <div className="relative h-64 w-full overflow-hidden">
            <Image
      ...
      {/* Featured Products - Modern Layout */}
      <section ref={productsRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="container mx-auto max-w-7xl">
          <div className={`flex flex-col sm:flex-row items-center justify-between mb-10 transition-all duration-700 ${productsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                <Sparkles className="w-4 h-4 text-primary" />
                <span className="text-sm text-primary font-medium">Best Sellers</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground">Popular Products</h2>
              <p className="text-muted-foreground mt-2">Our most trusted cleaning solutions</p>
            </div>
            <Link href="/products">
              <Button variant="outline" className="group mt-4 sm:mt-0">
      ...
      {/* Working Areas - Modern Grid */}
      <section ref={areasRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-muted/50 to-background">
        <div className="container mx-auto max-w-7xl">
          <div className={`text-center mb-12 transition-all duration-700 ${areasVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
              <Globe className="w-4 h-4 text-primary" />
              <span className="text-sm text-primary font-medium">Global Reach</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">Where We Operate</h2>
            <p className="text-base text-muted-foreground max-w-2xl mx-auto">
              Serving businesses across multiple regions with reliable distribution networks.
            </p>
          </div>
      ...
      {/* Services/Capabilities - Modern Cards */}
      <section ref={servicesRef} className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary via-primary/95 to-primary">
        <div className="container mx-auto max-w-7xl">
          <div className={`text-center mb-12 transition-all duration-700 ${servicesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 mb-4">
              <Sparkles className="w-4 h-4 text-white" />
              <span className="text-sm text-white font-medium">Core Capabilities</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">What We Do Best</h2>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="container mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 p-10 sm:p-12 text-center">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl" />
            <div className="relative z-10">
              ...
              <Link href="/contact">
                <Button className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white h-11 text-base px-8 shadow-lg shadow-primary/25 hover:shadow-xl transition-all duration-300 group">
                  Get Started Today
                  <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
                </Button>
              </Link>
